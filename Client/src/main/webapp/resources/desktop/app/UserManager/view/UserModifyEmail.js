...
Ext.define('Wdesktop.app.UserManager.view.UserModifyEmail', {
	extend : 'Ext.form.Panel',

	alias : "widget.userModifyEmail",
	...
	title : '修改绑定邮箱',
	method : 'post',
	url : 'userManager/modifyEmail.json',
	timeout : 100000,
	waitTitle : '正在提交中...',
	...
	onFormDataLoad : function() {
		var me = Ext.ComponentQuery.query('userModifyEmail')[0];
		if(!me){
			me = this;
		}
