...
Ext.define('Wdesktop.app.UserManager.view.UserModifyPassword', {
	extend : 'Ext.form.Panel',

	alias : "widget.userModifyPassword",
	...
	title : '修改密码',
	method : 'post',
	url : 'userManager/modifyPassword.json',
	timeout : 100000,
	waitTitle : '正在提交中...',
	...
	onFormDataLoad : function() {
		var me = Ext.ComponentQuery.query('userModifyPassword')[0];
		if(!me){
			me = this;
		}
