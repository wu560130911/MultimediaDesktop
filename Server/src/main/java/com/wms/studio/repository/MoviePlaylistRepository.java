...
public interface MoviePlaylistRepository extends
		...
		JpaSpecificationExecutor<MoviePlaylist> {

	List<MoviePlaylist> findByUser(User user);

	Page<MoviePlaylist> findByUser(User user, Pageable pageable);

	List<MoviePlaylist> findByUserAndMovie(User user, Movie movie);
