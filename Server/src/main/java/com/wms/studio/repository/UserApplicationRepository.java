...
public interface UserApplicationRepository extends
		...
		JpaSpecificationExecutor<UserApplication> {

	List<UserApplication> findByQuickStartTrueAndUser(User user);

	List<UserApplication> findByDesktopIconTrueAndUser(User user);

	List<UserApplication> findByStartMenuTrueAndUser(User user);

	List<UserApplication> findByUserAndApp(User user, Application app);
