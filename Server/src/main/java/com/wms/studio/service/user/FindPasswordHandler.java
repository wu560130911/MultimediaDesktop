 ...
 *
 */
@Service("findPasswordHandler")
public class FindPasswordHandler implements UserMailHandler {
	...
	public MailMessage handlerMailMessage(String email, User user) {
		...
		dto.setType(EmailConstant.EMAIL_USER_FIND_PASSWORD);// 邮件类型
		...
		MailMessage mailMessage = new MailMessage(
				EmailConstant.EMAIL_USER_FINDPASSWORD_TITLE);
